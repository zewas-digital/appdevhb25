...
{
    public class PersonGroupCreator2
    {
        ...
        public static void Start()
        {
            ...
            List<Person> personsSortedAgeAsc = g1.SortByAge(true);
            Group.PrintGroop(personsSortedAgeAsc);

            List<Person> personsSortedHeightDesc = g2.SortByHeight(false);
            Group.PrintGroop(personsSortedHeightDesc);
            g2.RemovePerson("12345");
            Group.PrintGroop(g2.persons);
        }
    }
}
