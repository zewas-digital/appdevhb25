namespace Appdevhb25.LauraKatharinaBertsch.ZooTeil4
{
    public class Main
    {
        public static void Start()
        {
            ...
            Carer carer1 = new Carer("Peter");
            dschungel.AddCarer(carer1);
            Carer carer2 = new Carer("Anneliese");
            nordpool.AddCarer(carer2);
            savanne.AddCarer(carer2);
